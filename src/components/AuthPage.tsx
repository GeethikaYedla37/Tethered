...
export default function AuthPage({ onEnter }: { onEnter: (name: string, code: string) => void }) {
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            <motion.div 
              ...
              exit={{ opacity: 0, x: 20 }}
            >
              <p className="text-center text-soft mb-6 font-sans text-sm">What should your friend call you?</p>
              <input 
                value={name} 
              ...
              {mode === 'join' ? (
                <>
                  ...
                  <input 
                    ...
                    autoFocus
                    onKeyDown={e => e.key === 'Enter' && code.trim() && onEnter(name, code.toUpperCase())}
                  />
                </>
              ) : (
                <div className="text-center mb-6">
                  ...
                  <p className="text-soft font-sans text-sm">We'll generate a unique, secure connection code for your new space.</p>
                </div>
              )}
